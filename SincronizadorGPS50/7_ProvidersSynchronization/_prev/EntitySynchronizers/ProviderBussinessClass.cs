...
{
   public class ProviderBussinessClass : BaseMaster
   {
      ...
      public override bool _Load(ref dynamic toeCustomer)
      {
         ...
         if(toeCustomer != null)
         {
            ...
            { this._Error_Message += "No se a indicado el códgo del proveedor o la longitud del codigo es diferente a " + _nDigitos + " digitos \r\n"; }
      ...
      public override bool _Create(dynamic toeCustomer)
      {
         ...
         if(toeCustomer != null)
         {
            ...
            {
               // comprobamos que el codigo ingresado sea del tipo valido para proveedor.
               if(FUNCTIONS._Es_Proveedor(toeCustomer.codigo))
               {
                  //_oProveedor = new Cliente();
                  _oProveedor = new Proveedor();
                  ...
                  if(!_oProveedor._Existe_Registro())
                  {
                     ...
                     //{
                     //   // si es una cuenta de proveedor contado (creamos la cuenta con valores fijos.. previsionalmente)
                     ...
                     if(llOk)
                     {
                        //// Si le enviamos la coleccion del mandato del proveedor, la agregamos
                        //if(toeCustomer.mandato != null)
                        //{
                        //   if(string.IsNullOrEmpty(toeCustomer.proveedor))
                        //      toeCustomer.proveedor = toeCustomer.codigo;
                        ...
                        //   //    loMandato.proveedor = _oProveedor._Codigo;
                        //   //    loMandato = null;
                        //}
                     }
                     else
                  ...
                  { this._Error_Message += "El código de proveedor ya existe\r\n"; }
               }
            }
            _oProveedor = null;
         }
      ...
      //              "From {0} a Left Join {1} b On a.codigo = b.proveedor and orden = 1 " +
      //              "Where a.codigo = {2} ";
      //      lsSQL = string.Format(lsSQL, DB.SQLDatabase("CLIENTES"), DB.SQLDatabase("BANC_CLI"), toMandate.proveedor);

      //      DB.SQLExec(lsSQL, ref loDatosCliente);


      //      loVista._AppendBlank();
      //      //loVista._CurrentRow["proveedor"] = toMandate.proveedor;

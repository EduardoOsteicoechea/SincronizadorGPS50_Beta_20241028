...
{
   public class SubaccountableAccountsSynchronizationTableSchemaProvider : ISynchronizationTableSchemaProvider
   {
      # region entityStaticDataProviders
         public static string EntitySynchronizationTableName { get; set; } = "INT_SAGE_SINC_CUENTAS_CONTABLES";
         public static string GestprojectEntityTableNameProvider { get; set; } = "CONTAPLUS_SUBCUENTA";
         ...
         {
            /*0*/("COS_ID", $"Id en Gestproject", typeof(int), "INT", null),
            /*1*/("COS_CODIGO", "Código", typeof(string), "VARCHAR(MAX)", string.Empty),
            /*2*/("COS_NOMBRE", "Nombre", typeof(string), "VARCHAR(MAX)", string.Empty),
            /*3*/("COS_GRUPO", "Grupo", typeof(string), "VARCHAR(MAX)", string.Empty),
         };
      ...
      # region entityRequiredProperties
         ...
         # region entitySynchronizationTableName
            ...
            public string GestprojectEntityTableName { get; set; } = GestprojectEntityTableNameProvider;

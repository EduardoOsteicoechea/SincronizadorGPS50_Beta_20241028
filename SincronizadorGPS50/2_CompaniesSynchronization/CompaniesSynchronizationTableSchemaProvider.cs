...
{
   public class CompaniesSynchronizationTableSchemaProvider : ISynchronizationTableSchemaProvider
   {
      public static string EntitySynchronizationTableName { get; set; } = "INT_SAGE_SINC_EMPRESAS";
      ...
      {         
         ...
         /*1*/("PAR_NOMBRE", "Nombre de Empresa", typeof(string), "VARCHAR(MAX)", string.Empty),
         /*2*/("PAR_CIF_NIF", "CIF/NIF", typeof(string), "VARCHAR(MAX)", string.Empty),
         /*3*/("SageCompanyNumber", "Codigo de Sage", typeof(string), "VARCHAR(MAX)", string.Empty),
      };

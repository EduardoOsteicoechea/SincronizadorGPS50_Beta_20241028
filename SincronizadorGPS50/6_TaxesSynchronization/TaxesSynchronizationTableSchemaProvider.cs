...
namespace SincronizadorGPS50
{
   public class TaxesSynchronizationTableSchemaProvider : ISynchronizationTableSchemaProvider
   {
      # region entityStaticDataProviders
         public static string EntitySynchronizationTableName { get; set; } = "INT_SAGE_SINC_IMPUESTOS";
         ...
         {
            /*0*/("IMP_ID", $"Id en Gestproject", typeof(int), "INT", null),
            /*1*/("IMP_TIPO", "Tipo de impuesto en Gestproject", typeof(string), "VARCHAR(MAX)", string.Empty),
            /*2*/("IMP_NOMBRE", "Nombre", typeof(string), "VARCHAR(MAX)", string.Empty),
            /*3*/("IMP_DESCRIPCION", "Descripción", typeof(string), "VARCHAR(MAX)", string.Empty),
            /*4*/("IMP_VALOR", "Valor", typeof(decimal), "DECIMAL(18,2)", null),
            /*5*/("IMP_SUBCTA_CONTABLE", "Subcuenta contable", typeof(string), "VARCHAR(MAX)", string.Empty),
            /*6*/("IMP_SUBCTA_CONTABLE_2", "Subcuenta contable 2", typeof(string), "VARCHAR(MAX)", string.Empty),
         };
         ...
         (
            ...
            new List<(string name, Type type)>() 
            {
               ...
               /*1*/("IVA", typeof(decimal)),
               /*2*/("NOMBRE", typeof(string)),
               /*3*/("CTA_IV_REP", typeof(string)),
               /*4*/("CTA_IV_SOP", typeof(string)),
               /*5*/("CODIGO", typeof(string)),
            }
         );
         static ((string sageDispactcherMechanismRoute, string tableName) dispatcherAndName, List<(string name, Type type)> tableFieldsAlongTypes) SageTableDataProvider2 { get; set;} = 
         (
            ("gestion","tipo_ret"),
            new List<(string name, Type type)>() 
            {
               /*0*/("GUID_ID", typeof(string)),
               /*1*/("NOMBRE", typeof(decimal)),
               /*2*/("RETENCION", typeof(string)),
               /*3*/("CTA_RE_REP", typeof(string)),
               /*4*/("CTA_RE_SOP", typeof(string)),
               /*5*/("CODIGO", typeof(string)),
            }
         );
      ...
      # region entityRequiredProperties
         ...
         # region entityGestprojectDataProperties
            ...
            public (string ColumnDatabaseName, string ColumnUserFriendlyNane, Type ColumnValueType, string columnDefinition, dynamic defaultValue) GestprojectType { get; set; } = 
            ...
            public (string ColumnDatabaseName, string ColumnUserFriendlyNane, Type ColumnValueType, string columnDefinition, dynamic defaultValue) GestprojectDescription { get; set; } =
            GestprojectDataTuples.ElementAt(3);
            public (string ColumnDatabaseName, string ColumnUserFriendlyNane, Type ColumnValueType, string columnDefinition, dynamic defaultValue) GestprojectValue { get; set; } = 
            ...
            public (string ColumnDatabaseName, string ColumnUserFriendlyNane, Type ColumnValueType, string columnDefinition, dynamic defaultValue) AccountableSubaccount2 { get; set; } = 

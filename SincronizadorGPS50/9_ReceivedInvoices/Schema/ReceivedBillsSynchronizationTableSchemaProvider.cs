...
namespace SincronizadorGPS50
{
   public class ReceivedBillsSynchronizationTableSchemaProvider : ISynchronizationTableSchemaProvider
   {
      ...
      public static List<(string columnName, string friendlyName, Type columnType, string columnDefinition, dynamic defaultValue)> GestprojectDataTuples { get; set; } = new List<(string, string, Type, string, dynamic)>()
      {
         ...
         /*2*/("FCP_NUM_FACTURA", "Número de factura", typeof(string), "VARCHAR(MAX)", string.Empty),
         /*3*/("FCP_FECHA", "Fecha de factura", typeof(DateTime), "DATETIME", null),
         /*4*/("PAR_PRO_ID", "Id de proveedor", typeof(int), "INT", null),
         /*5*/("FCP_SUBCTA_CONTABLE", "Cuenta contable de factura", typeof(string), "VARCHAR(MAX)", string.Empty),
         /*6*/("FCP_BASE_IMPONIBLE", "Base imponible", typeof(decimal), "DECIMAL(18,2)", null),
         /*7*/("FCP_VALOR_IVA", "IVA valor", typeof(decimal), "DECIMAL(18,2)", null),
         /*8*/("FCP_IVA", "IVA tipo", typeof(decimal), "DECIMAL(18,2)", null),
         /*9*/("FCP_VALOR_IRPF", "Retención valor", typeof(decimal), "DECIMAL(18,2)", null),
         /*10*/("FCP_IRPF", "Retención tipo", typeof(decimal), "DECIMAL(18,2)", null),
         /*11*/("FCP_TOTAL_FACTURA", "Valor total de factura", typeof(decimal), "DECIMAL(18,2)", null),
         /*12*/("FCP_OBSERVACIONES", "Observaciones", typeof(string), "VARCHAR(MAX)", string.Empty),
         /*13*/("PRY_ID", "Id de obra", typeof(int), "INT", null),
         /*14*/("FCP_EJERCICIO", $"Ejercicio", typeof(string), "VARCHAR(MAX)", string.Empty),
      };
